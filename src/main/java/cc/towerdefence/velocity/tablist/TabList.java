...
public class TabList {
    ...
    private void updateFooter() {
        ListenableFuture< PlayerTrackerProto.GetServerTypePlayerCountResponse> responseFuture = this.playerTracker.getServerTypePlayerCount(
                PlayerTrackerProto.ServerTypeRequest.newBuilder()
                .setServerType("velocity").build());
        ...
        Futures.addCallback(responseFuture, FunctionalFutureCallback.create(
                ...
                throwable -> {
                    LOGGER.error("Failed to update tab list footer: ", throwable);
                }
